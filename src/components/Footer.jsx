...
export default function FooterDailyDose() {
  return (
    <footer className="font-sans">
      ...
      <div className="bg-[#EBC2C8] text-black text-center py-10 md-5 px-5">
        ...
        <p className="text-[12px] font-[400] text-black/60 tracking-[0.05em] max-w-lg mx-auto mb-8">
          Get exclusive offers, the latest trends &amp; our new arrivals delivered straight to your inbox!
        </p>
        <Link to="/analysis"
      ...
      <div className="bg-[#F5F5F6] px-6 md:px-12 py-14">
        <div className="max-w-[1180px] mx-auto grid grid-cols-1 md:grid-cols-[1fr_1fr_1fr] gap-12">
          ...
          {/* Center: Help */}
          <div>
            <p className="text-[9px] font-[700] uppercase tracking-[0.45em] text-[#221D1D] mb-5">Help</p>
            <ul className="flex flex-col gap-3">
              {[
                { name: "Customer Service", to: "/about" },
                { name: "About AuraMatch", to: "/about" },
              ].map(link => (
                <li key={link.name}>
                  <Link to={link.to}
          ...
          {/* Right: Explore */}
          <div>
            <p className="text-[9px] font-[700] uppercase tracking-[0.45em] text-[#221D1D] mb-5">Explore</p>
            <ul className="flex flex-col gap-3">
              {[
                { name: "Color Analysis", to: "/analysis" },
                { name: "Style Advisor", to: "/advisor" },
                { name: "Makeup Looks", to: "/looks" },
                { name: "Shop", to: "/cosmetics" },
      ...
      <div className="bg-white border-t border-[#E0DAD5] px-6 md:px-12 py-6">
        <div className="max-w-[1180px] mx-auto flex flex-col gap-2">
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-1">
            {["Terms of Use", "Privacy & Security", "Contact Us", "Sign In"].map((item, i, arr) => (
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@500&family=Montserrat:wght@400;600;700;800&display=swap');
